...
function agregarProducto() {
  ...
  if (cantidad > 0) {
    $("#error").html("");
    var itemId = parseInt($("#tragos").val());
...
function dibujarPedido() {
  var tablaHeader = `<table class="table table-hover table-primary finalizar-pedido">
  <thead>
    <tr class="items">
      <th scope="col">#</th>
  ...
  <h2>complete sus datos para el envio de las bebidas
  al finalizar precione el boton finalizar pedido</h2>
